...
ListaDubla stergeCafeneaDupaNuma(ListaDubla listaDubla, const char* nume) {
    if (nume == NULL) {
        return listaDubla;
    }
    Nod* nod = listaDubla.cap;
...
void main()
{
    ...
    listaDubla.cap = listaDubla.coada = NULL;
    Nod* first = NULL;
    Nod* last = NULL;
    ...
    /*listaDubla = stergeCafeneaDupaNuma(listaDubla, "Teds");
    afisareLista(listaDubla);
    listaDubla = stergeCafeneaDupaNuma(listaDubla, "Tucano");
    afisareLista(listaDubla);
    listaDubla = stergeCafeneaDupaNuma(listaDubla, "Starbucks");
    afisareLista(listaDubla);
    listaDubla = stergeCafeneaDupaNuma(listaDubla, "Sb");
    afisareLista(listaDubla);
    listaDubla = stergeCafeneaDupaNuma(listaDubla, "Urban");
    afisareLista(listaDubla);*/
    //listaDubla = stergeLista(listaDubla);
    //afisareLista(listaDubla);
    int a = NrTotalLocuri(listaDubla);
    printf("Nr total locuri: %d",a);
}